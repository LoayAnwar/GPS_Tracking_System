...
//Global variables
int numbers[10] = { 0x40,0x79,0x24,0x30,0x19, 0x12,0x02,0x78,0x00,0x10 }; // to show numbers in display
int digit1, digit2, digit3, digit4;		// Number to be displayed in each digit
unsigned long SW2;										// On-board push button to test 
...
void Display(int digit, int number) {
    GPIO_PORTB_DATA_R = 0x00;							// Turns off LEDs of 7 segment.
